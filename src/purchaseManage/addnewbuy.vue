<template>
  ...
  <div>
    ...
    <el-form :model="user" ref="user" :rules="rules" label-width="120px">
      <el-row>
        <el-col :span="8">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="采购单总价" prop="poTotal">
            <el-input v-model="totalPrice" readonly unselectable="on"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="最低预付款金额" prop="prePayFee">
            <el-input placeholder="金额" v-model="user.prePayFee" :disabled="flag"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-table :data="user.poitems" style="width: 100%">
        ...
        <el-table-column prop="productCode" label="产品编号">
          ...
          <template slot-scope="scope">
            ...
            <div style=" display:flex">
              <el-input v-model="scope.row.productCode" readonly></el-input>
              <el-button
                type="primary"
        ...
        <el-table-column prop="itemPrice" label="明细价格">
          <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      user: {
        poId: "", //采购单编号
        venderCode: "", //供应商编号
        account: cookie.get("account"), //创建用户
        createTime: "", //创建时间
        tipFee: "0", //附加费用
        productTotal: "", //产品总价
        poTotal: "", //采购总价
      ...
      rules:{
         venderCode: [
          ...
          tipFee: [
            ...
            { pattern: /^((?:-?0)|(?:-?[1-9]\d*))(?:\.\d{1,2})?$/, message: '只能输入整数，小数至多两位' } 
          ],
          payType: [
  ...
  computed: {
    ...
    totalPrice() {
      ...
      this.user.poTotal =Number(this.user.productTotal) + Number(this.user.tipFee)+Number(this.user.prePayFee);
       return this.user.poTotal
    }
  },
  methods: {
    handleEdit() {
