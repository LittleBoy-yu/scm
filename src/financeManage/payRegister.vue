  ...
  <div>
    <el-tabs v-model="activeName">
      <el-tab-pane label="货到付款" name="1">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column align="center" prop="poId" label="销售单编号" width="140"></el-table-column>
          ...
          <el-table-column prop="poTotal" label="销售单总价格" width="110"></el-table-column>
          ...
          <el-table-column align="center" label="操作" width="100">
            <template slot-scope="scope">
              ...
              <el-button @click="display(scope.row)" type="text" size="small">付款</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
    ...
    <el-dialog title="销售单详情" :visible.sync="dialogVisible" width="60%">
      <el-table :data="detailsData" style="width: 100%" class="detailsData">
        <el-table-column prop="poId" label=" 销售单编号" width="145"></el-table-column>
    ...
    <el-dialog title="销售单收款" :visible.sync="dialogVisible1" width="30%">
      ...
      <p><span>{{displayData.poId}}</span><span class="money">{{displayData.money}}</span></p>
      <button type="primary" @click="handleClick" :plain="true">付款</button>
    </el-dialog>
  </div>
</template>
<script>
      ...
      this.$confirm(
        ...
        .then(() => {
          if(this.gathering == 2){
            ...
            this.displayData.money = row.poTotal - row.prePayFee;
          } else {
            this.displayData.money = row.poTotal;
          };
          this.displayData.poId=row.poId
