    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="货到付款"  name="1">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="productTotal" label="销售产品总价" width="110"></el-table-column>
          ...
          <el-table-column align="center"  label="处理状态" width="100">可出库</el-table-column>
          <el-table-column align="center" label="操作" width="100">
            <template slot-scope="scope">
               <el-button @click="details(scope.row)" type="text" size="small">详情</el-button>
              <el-button @click="handleClick(scope.row)" type="text" size="small">出库</el-button>>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
      ...
      <el-tab-pane label="款到发货" name="2">
        <el-table :data="tableData" border style="width: 100%">
         ...
         <el-table-column align="center" label="客户名称" width="130">
          ...
          <el-table-column prop="prePayFee" label="最低预付款金额" width="120"></el-table-column>
          <el-table-column align="center" prop="type" label="处理状态" width="100">可出库</el-table-column>
      ...
      <el-tab-pane label="预付款到货" name="3">
        <el-table :data="tableData" border style="width: 100%">
         ...
         <el-table-column align="center" label="客户名称" width="130">
          ...
          <el-table-column prop="prePayFee" label="最低预付款金额" width="120"></el-table-column>
          <el-table-column align="center" v-model="type" label="处理状态" width="100">可出库</el-table-column>
          <el-table-column align="center" label="操作" width="100">
            <template slot-scope="scope">
               <el-button @click="details(scope.row)" type="text" size="small">详情</el-button>
              <el-button @click="handleClick(scope.row)" type="text" size="small">出库</el-button>>
...
export default {
  ...
  methods: {
    ...
    handleClick(row) {
      this.$confirm("即将将此订单货物出库, 是否继续?", "提示", {
