<template>
  <div>
    ...
    <el-row class="report">
      <el-col :span="6">入库单据数&emsp;：{{main.total}}</el-col>
      <el-col :span="6">产品总数量&emsp;：{{main.totalNum}}</el-col>
      <el-col :span="6">入库产品总金额&emsp;：{{main.productTotal}}</el-col>
    </el-row>
    ...
    <el-table class="dislog" :data="tableData" style="width: 100%;" align="center">
      ...
      <el-table-column label="采购单号" prop="poId" width="250"></el-table-column>
      <el-table-column label="入库日期" prop="stockTime" width="250"></el-table-column>
